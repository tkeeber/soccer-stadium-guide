...
public abstract class MyAsyncTask<Params, Progress, Result> {
	...
	private static List<FutureTask> mFutures;
	...
	public MyAsyncTask() {
		...
		mFuture = new FutureTask<Result>(mWorker) {
			...
			protected void done() {
				...
				try {
					...
					message = sHandler.obtainMessage(MESSAGE_POST_CANCEL, new AsyncTaskResult<Result>(MyAsyncTask.this, (Result[]) null));
		...
		if (mFutures == null) {
			mFutures = new ArrayList<FutureTask>();
		}
		mFutures.add(mFuture);
	}
	...
	public static boolean cancelAll(boolean mayInterruptIfRunning) {
		boolean canceled = true;
		if (mFutures == null) {
			return true;
		}
		for (FutureTask future : mFutures) {
